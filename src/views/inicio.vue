    ...
    <section class="secao-noticias">
      ...
      <div class="grade-noticias">
        <div class="card-noticia">
          ...
          <div class="card-body">
            <span class="card-tag">Institucional</span>
            <h3>Novidades do Semestre</h3>
            <p>Confira as atualizações na infraestrutura do campus e os planos para o próximo período.</p>
